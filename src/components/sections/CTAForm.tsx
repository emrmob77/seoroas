      ...
      <div className="max-w-5xl mx-auto bg-white/70 backdrop-blur-3xl rounded-[3rem] p-12 md:p-24 soft-shadow border-[0.5px] border-outline-variant/10 text-center relative overflow-hidden">
        <div className="relative z-10">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full bg-primary text-white py-6 rounded-full font-bold uppercase tracking-[0.2em] text-xs hover:shadow-lg hover:-translate-y-1 transition-all duration-300 mt-8"
            >
              Analizi Gönder
            </button>
          </form>
