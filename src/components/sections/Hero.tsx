...
export function Hero() {
  return (
    <section className="relative min-h-screen pt-48 pb-32 px-8 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        {/* H1 */}
        <h1 className="text-6xl md:text-[5.5rem] font-extrabold leading-[1.05] tight-tracking text-on-background max-w-5xl mb-12">
          10X Organik <br />
        ...
        <div className="w-full max-w-4xl bg-white/40 backdrop-blur-xl border-[0.5px] border-outline-variant/20 rounded-3xl p-8 md:p-12 soft-shadow flex flex-wrap justify-between items-center gap-8">
          {stats.map((stat, i) => (
          ...
          <Link
            href="/iletisim"
            className="bg-primary text-white p-4 rounded-full flex items-center justify-center hover:scale-105 transition-transform duration-300"
          >
