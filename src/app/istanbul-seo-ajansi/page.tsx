...
export const metadata: Metadata = generateSeoMetadata({
  title: "İstanbul SEO Ajansı — Yerel & Kurumsal SEO",
  description:
...
export default function IstanbulSeoAjansiPage() {
  return (
    <>
      ...
      <SubpageHero
        breadcrumb={[
          { name: "İstanbul SEO Ajansı", url: "/istanbul-seo-ajansi" },
        ]}
        badge="İstanbul Bölgesi Aktif"
        title={
          <>
            İstanbul{" "}
        ...
        subtitle="Türkiye'nin ekonomik başkenti İstanbul'da markanızı dijital arama sonuçlarının zirvesine taşıyoruz. 16 milyonluk devasa pazarda rakiplerinizin önüne geçin."
        stats={stats}
      />
