...
export const metadata: Metadata = generateSeoMetadata({
  ...
  description:
    "İzmir'in dinamik ticaret ekosisteminde markanızı dijital arama sonuçlarında öne çıkarıyoruz. Ege bölgesinin lider SEO ajansı.",
    ...
    <>
      ...
      <header className="relative pt-28 md:pt-36 pb-12 md:pb-20 px-5 md:px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto space-y-6 md:space-y-10">
          <Breadcrumb
            items={[{ name: "İzmir SEO Ajansı", url: "/izmir-seo-ajansi" }]}
          />
          ...
          <p className="text-base md:text-xl text-on-surface-variant max-w-2xl font-light leading-relaxed">
            Ege&apos;nin ticaret başkenti İzmir&apos;de dijital görünürlüğünüzü
            maksimize ediyoruz. İhracat, turizm ve e-ticaret odaklı SEO
            stratejileri ile büyüyün.
          </p>
