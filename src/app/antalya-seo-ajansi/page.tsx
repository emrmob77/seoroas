...
export default function AntalyaSeoAjansiPage() {
  return (
    <>
      ...
      <SubpageHero
        breadcrumb={[
          { name: "Antalya SEO Ajansı", url: "/antalya-seo-ajansi" },
        ]}
        badge="Antalya Bölgesi Aktif"
        title={
          <>
            Antalya{" "}
        ...
        subtitle="Türkiye'nin turizm başkenti Antalya'da uluslararası görünürlüğünüzü maksimize ediyoruz. Turizm, sağlık turizmi ve gayrimenkul sektörlerinde çok dilli SEO stratejileri."
        stats={stats}
      />
