...
const clients: { name: string; url: string; logo: string | null; dark?: boolean }[] = [
  ...
  { name: "Yıldız Mobilya", url: "https://yildiz-mobilya.com", logo: "https://cdn.sanity.io/images/67vl8x07/production/d089c3c1a7ca2996d40760273d192049e5d92df8-900x116.png", dark: true },
