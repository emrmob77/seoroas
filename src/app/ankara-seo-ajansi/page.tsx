...
export default function AnkaraSeoAjansiPage() {
  return (
    <>
      ...
      <SubpageHero
        breadcrumb={[
          { name: "Ankara SEO Ajansı", url: "/ankara-seo-ajansi" },
        ]}
        badge="Ankara Bölgesi Aktif"
        title={
          <>
            Ankara{" "}
        ...
        subtitle="Başkentin kurumsal gücünü dijitale taşıyoruz. Kamu, savunma sanayi ve teknoloji sektörlerinde Ankara'nın en güvenilir SEO partneri."
        stats={stats}
      />
