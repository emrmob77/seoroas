...
const updatedData = {
  ...
  appAudit: [
    { appName: "Bold (Subscriptions, Upsell, Product Options)", impact: "Çok yüksek JavaScript yükü, Core Web Vitals'i ciddi düşürüyor", recommendation: "Gereksizse tamamen kaldır. Alternatif daha hafif çözümler kullan." },
    { appName: "Birçok üçüncü parti chat, popup, tracking script", impact: "Her sayfada ekstra script yükleniyor", recommendation: "Sadece gerekli sayfalarda yükle veya lazy load et." },
    { appName: "Ağır tema özellikleri (mega menu, quick view, 3D, countdown)", impact: "Kullanılmayan özelliklerin JS'i her sayfada yükleniyor", recommendation: "Tema ayarlarından kullanmadıklarını devre dışı bırak." }
  ],
  themeAdvice: [
  ...
  realResults: [
    { example: "Bir mağaza sahibi premium temadan Dawn'a geçti", before: "4.3 saniye yükleme süresi, %1.6 dönüşüm oranı", after: "1.8 saniye yükleme süresi, %3.1 dönüşüm oranı" },
    { example: "Çok fazla uygulama kurulu mağazalarda yaygın sorun", before: "20+ uygulama ile yavaş yükleme ve yüksek bounce rate", after: "Kritik uygulamalarla temizlenince hız ve UX belirgin iyileşti" }
  ],
...
async function apply() {
  ...
  const result = await client.patch(doc._id).set(updatedData).commit();
